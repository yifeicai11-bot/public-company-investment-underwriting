...
EXCLUDED_PRIOR_ISSUERS = [
    ...
    {"ticker": "AZO", "reason": "Existing v1.0.0 and retail fixture."},
    {"ticker": "BA", "reason": "Previously used liquidity and refinancing review."},
    {"ticker": "CMT", "reason": "Previously used user-facing issuer review."},
    {"ticker": "CRM", "reason": "Existing software valuation fixture."},
    {"ticker": "CROX", "reason": "Existing v1.0.0 and valuation fixture."},
...
FROZEN_SHARED_LOGIC = [
    ...
    "user-demo/investment_decision_v2/scripts/build_public_company_decision_pack.py",
    "user-demo/investment_decision_v2/scripts/notes_events_controls.py",
    "user-demo/investment_decision_v2/scripts/build_public_company_investment_layer.py",
    "user-demo/investment_decision_v2/scripts/underwriting_contract.py",
    "user-demo/investment_decision_v2/scripts/equity_valuation_contract.py",
    ...
    "user-demo/investment_decision_v2/scripts/run_blind_company_forward_test.py",
    "user-demo/investment_decision_v2/scripts/validate_s17_held_out_run.py",
    "user-demo/investment_decision_v2/blind_tests/blind_test_manifest.schema.json",
]
