...
def _approval_checks(
    ...
    *,
    ...
    add_check(
        ...
        message_pass="The complete controlled User decision set is configured.",
        message_fail="The configured User decision set is incomplete or unsupported.",
    ...
    add_check(
        checks,
        check_id="G4I-user-decision-completeness",
        document="approval",
        passed=decision_valid,
        field="partner_decision",
        message_pass="User decision fields are complete for the selected status.",
        message_fail="User decision fields are inconsistent with the selected status.",
    ...
    add_check(
        ...
        message_pass="User decision status is valid for the current workflow stage.",
        message_fail="A User decision cannot be approved before the system assessment is ready.",
