# C. H. ROBINSON WORLDWIDE, INC. (CHRW) Public Company Decision-Support Data Pack
...
- Latest quarterly filing: 10-Q filed 2026-07-31, period 2026-06-30.
- Latest annual filing: 10-K filed 2026-02-13, period 2025-12-31.
...
- Visible liquid resources before facility-note availability review are $154.6m.
- Current lease obligations identified are $70.7m; current debt alone should not be treated as total near-term obligations.
- YTD FCF is $96.9m; latest-quarter FCF is $30.9m where derivable.
...
|---|---:|---|---|---|
| Unrestricted cash | $154.6m | 2026-06-30 | FACT/instant | Immediate cash, before restricted-cash caveat |
| Cash + restricted cash | $154.6m | 2026-06-30 | FACT/instant | Cash-flow reconciliation, not fully available liquidity |
| Cash + short-term investments | $154.6m | 2026-06-30 | CALC/instant | Liquidity before revolver/facility note review |
| Current lease obligations | $70.7m | 2026-06-30 | CALC/instant | Mandatory uses not captured by current debt |
| YTD FCF | $96.9m | 2026-01-01 to 2026-06-30 | CALC/YTD | Cash generation, period-specific |
| Derived latest-quarter FCF | $30.9m | 2026-04-01 to 2026-06-30 | CALC/derived-quarter | Same-period cash conversion if derivable |
| DSO | 51.6 days | 2026-04-01 to 2026-06-30 | CALC/quarter | Receivables collection pressure |
...
| P1-note-leases | PASS | Lease carrying values and contractual payment language were located and remain separately classified. | The control does not constrain the current output. |
...
| P0-share-count-control | PASS | Point-in-time shares were selected as of 2026-07-29 from a filing published 2026-07-31. | The system separates point-in-time shares from weighted-average EPS shares and blocks future-publication leakage. |
...
| P0-balance-sheet-check | PASS | Assets $5,843.5m; liabilities + equity $5,843.5m. | Confirms statement extraction integrity. |
...
| P0-cash-definition-check | PASS | Cash $154.6m; cash + restricted cash $154.6m. | Prevents overstating usable cash. |
...
- Latest 10-Q: https://www.sec.gov/Archives/edgar/data/1043277/000104327726000031/chrw-20260630.htm
- Latest 10-K: https://www.sec.gov/Archives/edgar/data/1043277/000104327726000009/chrw-20251231.htm
- SEC companyfacts: https://data.sec.gov/api/xbrl/companyfacts/CIK0001043277.json
