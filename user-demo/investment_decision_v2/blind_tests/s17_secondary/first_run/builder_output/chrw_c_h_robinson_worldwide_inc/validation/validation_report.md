# C. H. ROBINSON WORLDWIDE, INC. (CHRW) Validation Report
...
| P1-note-leases | PASS | INFO | Info | Lease carrying values and contractual payment language were located and remain separately classified. | Preserve the source and rerun after the next filing. |
...
| P0-share-count-control | PASS | INFO | Critical | Point-in-time shares were selected as of 2026-07-29 from a filing published 2026-07-31. | Re-select shares against the exact market-price date before valuation. |
...
| P0-balance-sheet-check | PASS | INFO | Critical | Assets $5,843.5m; liabilities + equity $5,843.5m. | Investigate tag selection or noncontrolling-interest equity if fail. |
...
| P0-cash-definition-check | PASS | INFO | High | Cash $154.6m; cash + restricted cash $154.6m. | Use unrestricted cash for liquidity unless restricted cash is verified usable. |
