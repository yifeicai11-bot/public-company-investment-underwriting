# MAXIMUS, INC. (MMS) Validation Report
...
| P1-note-revolver | WARNING | WARNING | High | A revolver or credit-facility signal was located, but commitment, usage or availability, maturity, or restriction evidence is incomplete. | Borrowings or available capacity; Maturity or expiration; Borrowing-base, reserve, or borrowing-condition detail |
...
| P0-share-count-control | PASS | INFO | Critical | Point-in-time shares were selected as of 2026-05-04 from a filing published 2026-05-07. | Re-select shares against the exact market-price date before valuation. |
...
| P0-balance-sheet-check | PASS | INFO | Critical | Assets $4,239.2m; liabilities + equity $4,239.2m. | Investigate tag selection or noncontrolling-interest equity if fail. |
| P0-period-mismatch-block | PASS | INFO | Critical | Incompatible inputs were detected and not combined: quarter net income 2026-01-01 to 2026-03-31; YTD CFO 2025-10-01 to 2026-03-31. | Continue to use YTD/YTD, quarter/quarter, or validated derived-quarter metrics only. |
| P0-cash-definition-check | PASS | INFO | High | Cash $157.5m; cash + restricted cash $244.7m. | Use unrestricted cash for liquidity unless restricted cash is verified usable. |
...
| P1-working-capital-component-coverage | PROVISIONAL | WARNING | High | Available components: DSO; missing pending classification: DIO, DPO, CCC. No absent component is assumed to be zero. | Review the business model and filing definitions, then classify each unavailable component as NOT_APPLICABLE or MISSING before final underwriting. |
...
| P0-current-debt-vs-lease-check | PASS | INFO | Medium | Current debt $63.9m; current leases $35.4m. | Still include cash interest and capex. |
