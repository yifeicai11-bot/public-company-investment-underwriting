...
Use this file when the user asks for a partner-ready version, concise memo, first-page summary, or demo output. The one-page summary can stand alone or sit before the full review.

## Purpose

The Friday V1 one-page summary should let a partner understand the answer in approximately 30 seconds. Read `friday_v1_output_standard.md` before using the legacy module template below.
...
- Do not use "sample", "test case", "baseline", "stress case", or "useful for testing" in partner-facing summaries.
