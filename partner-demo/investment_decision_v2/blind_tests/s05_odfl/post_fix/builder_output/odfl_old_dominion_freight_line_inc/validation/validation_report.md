...
| P0-facility-reconciliation | PASS | INFO | Critical | Facility commitment $400.0m reconciles to availability and known reductions within $1.0m. | Retain note-level review for conditions, maturity, borrowing-base mechanics, and undisclosed restrictions. |
| P1-facility-note-check | PROVISIONAL | WARNING | High | Reported facility availability parsed as $368.2m; full note still needs review. | Read debt note and confirm commitment, availability, LC, reserves, maturity, borrowing base, and conditions. |
