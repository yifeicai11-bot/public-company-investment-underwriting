# TETRA TECH INC (TTEK) Validation Report
...
| P1-note-bad-debt | WARNING | WARNING | High | Bad-debt evidence is partial; allowance, methodology, and activity must remain separately identified. | Provision, write-off, or recovery activity |
...
| P0-fiscal-calendar-control | PASS | INFO | Critical | Validated fiscal-year context: NON_CALENDAR_FISCAL_YEAR, 52_WEEK, 364 days. | Re-evaluate the profile after every annual filing or restatement. |
...
| P0-share-count-control | PASS | INFO | Critical | Point-in-time shares were selected as of 2026-07-20 from a filing published 2026-07-31. | Re-select shares against the exact market-price date before valuation. |
...
| P0-balance-sheet-check | PASS | INFO | Critical | Assets $4,388.3m; liabilities + equity $4,388.3m. | Investigate tag selection or noncontrolling-interest equity if fail. |
| P0-period-mismatch-block | PASS | INFO | Critical | Incompatible inputs were detected and not combined: quarter net income 2026-03-30 to 2026-06-28; YTD CFO 2025-09-29 to 2026-06-28. | Continue to use YTD/YTD, quarter/quarter, or validated derived-quarter metrics only. |
| P0-cash-definition-check | PASS | INFO | High | Cash $230.8m; cash + restricted cash $230.8m. | Use unrestricted cash for liquidity unless restricted cash is verified usable. |
...
| P0-working-capital-opening-balance-alignment | PASS | INFO | Critical | Expected opening balance date 2026-03-29; extracted dates 2026-03-29. | Use the balance sheet dated one day before the quarter starts before calculating working-capital days. |
...
| P1-working-capital-component-coverage | PROVISIONAL | WARNING | High | Available components: DSO, DPO; missing pending classification: DIO, CCC. No absent component is assumed to be zero. | Review the business model and filing definitions, then classify each unavailable component as NOT_APPLICABLE or MISSING before final underwriting. |
