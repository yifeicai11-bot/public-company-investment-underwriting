...
| P0-unit-currency-control | FAIL | HARD_STOP | Critical | acquisition_unselected_fact_signal_1: expected MONETARY, received text | Reconcile the source units and reporting currency in the shared Data and Evidence Layer. |
