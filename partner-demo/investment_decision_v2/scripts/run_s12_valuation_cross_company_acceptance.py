...
REAL_CONTRACT_PATHS = {
    "CROX": (
        INVESTMENT_ROOT
        / "friday_v1_outputs/crox_crocs_inc/step3/underwriting_output_contract.json"
    ),
    "AZO": (
        INVESTMENT_ROOT
        / "friday_v1_outputs/azo_autozone_inc/step3/underwriting_output_contract.json"
    ),
    "CRM": (
        INVESTMENT_ROOT
        / "friday_v1_outputs/crm_salesforce_inc/step3/underwriting_output_contract.json"
    ),
    "ODFL": (
        INVESTMENT_ROOT
...
def _status_case_result(
    ...
    if partner_status != "DISABLED_PRIVATE_GATE_4_ONLY":
        errors.append("Partner Internal Return was not disabled.")
    prohibited_keys = {
        "target_price",
        "position_sizing",
        "portfolio_action",
