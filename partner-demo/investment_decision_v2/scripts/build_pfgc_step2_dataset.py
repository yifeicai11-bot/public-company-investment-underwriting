...
OUT_ROOT = ROOT / "partner-demo" / "investment_decision_v2" / "pfgc"
...
def build_validation_report(validations: list[dict[str, Any]]) -> str:
    ...
    lines.extend(
        [
            ...
            "## Memo Gate",
            "",
            "Because valuation, peer multiples, consensus, and normalized EBITDA are not complete in this Step 2 pack, the partner-facing output should remain a decision-support watch memo, not a Buy/Sell recommendation.",
            "",
        ]
    )
    return "\n".join(lines)
